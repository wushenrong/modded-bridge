...
Mods that are in Modded Bridge, this excludes library mods and modpack
management mods.

Mostly based on [Adrenaline](https://skywardmc.org/adrenaline) and
[Additive](https://skywardmc.org/additive).
...
-   [Quick Pack](https://modrinth.com/project/pSISfJ4O)
...
-   [Tag Translations for JEI](https://modrinth.com/project/dr1m8Rjk)

    Only for versions 1.21.11 or later.

-   [WITS (What Is This Structure?)](https://modrinth.com/project/AVo2esap)

## Server Side Only

Mods that are only installed on the server.

- [Krypton](https://modrinth.com/project/fQEb0iXm)
- [Nether Portal Fix](https://modrinth.com/project/nPZr02ET)
- [Very Many Players](https://modrinth.com/project/wnEe9KBa)
- [Disconnect Packet Fix](https://modrinth.com/project/rd9rKuJT)

## Optional Mods

Mods that is included in the pack but not install/enable by default. Be sure to
also install/enable any mod dependencies if they were not by default. If you run
a multiplayer server, you will need to also make sure to install/enable them on
both the server and client if recommended.

### Gameplay

Mods that can be considered a major gameplay change.
...
-   [RightClickHarvest](https://modrinth.com/project/Cnejf5xM)
    ...
    Requires [Architectury API](https://modrinth.com/project/lhGA9TYQ) for
...
Mods that enhances or overhauls Minecraft visuals or audio. Basically mods that
replace Optifine.
...
-   [Armor Hider](https://modrinth.com/project/GgG2my3y)[^1]
...
-   [Entity Model Features](https://modrinth.com/project/4I1XuqiY)
    ...
    Requires [Entity Texture Features](https://modrinth.com/project/BVzZfTc1).
...
-   [LambdaBetterGrass](https://modrinth.com/project/2Uev7LdA)
...
-   [OptiGUI](https://modrinth.com/project/JuksLGBQ)
    ...
    Requires [Animatica Refabricated](https://modrinth.com/project/xEyZuswh).
...
-   [Wavy Capes](https://modrinth.com/project/kYuIpRLv)
...
-   [CraftPresence](https://modrinth.com/project/DFqQfIBR)
    ...
    Requires [UniLib](https://modrinth.com/project/nT86WUER).
